...
app.post('/delete', async function (req, res) {
    if (req.isAuthenticated() && req.user && req.user.username) {
        ...
        try {
            ...
            const updatedTreatmentDetailsRCM0 = user.TreatmentDetailsRCM0.filter((_, index) => index !== parseInt(rowIndex));
            ...
            const updatedTreatmentDetailsEXT0 = user.TreatmentDetailsEXT0.filter((_, index) => index !== parseInt(rowIndex));
            ...
            await logindata.findByIdAndUpdate(
                user._id,
                {
                    ...
                    R34P: updatedR34P,
                    R35P: updatedR35P,
                    TreatmentDetailsRCM0: updatedTreatmentDetailsRCM0,
                    ...
                    TreatmentDetailsEXT0: updatedTreatmentDetailsEXT0,
